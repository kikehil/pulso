...
import { User, Mail, Shield, Briefcase, Building2 } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1">
          <div className="card text-center p-8">
            ...
            <h2 className="text-xl font-bold text-dark">{user?.name || 'Docente'}</h2>
            <p className="text-gray text-sm mb-4">Profesor</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-dark font-medium">Docente</p>
                </div>
              </div>

              <div className="flex items-start gap-3">
                <div className="p-2 bg-light rounded-lg">
                  <Briefcase className="w-5 h-5 text-gray" />
                </div>
                <div>
                  <p className="text-xs text-gray uppercase font-bold tracking-wider">Departamento</p>
                  <p className="text-dark font-medium">Ciencias de la Computación</p>
                </div>
              </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-amber-700 mt-1">
                  Para cambiar tu contraseña o actualizar tu información personal, por favor contacta al departamento de recursos humanos.
                </p>
              </div>
            </div>
          </div>
